...
This repository is a port of the "**RISCOF** RISC-V Architecture Test Framework" to test the
[NEORV32 RISC-V Processor](https://github.com/stnolting/neorv32) for compatibility to the RISC-V
ISA specifications. Currently, the following tests are supported:
...
* device-under-test: [`plugins/neorv32`](https://github.com/stnolting/neorv32-riscof/tree/main/plugins/neorv32)
* reference model: [`plugins/sail_cSim`](https://github.com/stnolting/neorv32-riscof/tree/main/plugins/sail_cSim)
